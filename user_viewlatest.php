			...
			<div class="header_sub">
				<div class="h_menu">
					<ul>
							...
							<li><a href="user_viewauthors.php">Authors</a></li>
							<li><a href="user_viewbooks.php">Books</a></li>
							<li class="active"><a href="user_viewlatest.php">Latest</a></li>
							<li><a href="user_uploadownbooks.php">Upload Your Book</a></li>
...
<?php 
//query the database
$query = "SELECT * FROM add_lat_book";
...
?>
<tr>
<td align="center"><a href="latest_fullview.php?p_name=<?php echo $p_id?>"><img src="latest_book_uploads/<?php echo $book_img;?>" width="120" height="150" /></td>
</a></td>
</tr>
<?php
