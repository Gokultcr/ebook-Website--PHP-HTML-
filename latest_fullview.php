...
<?php 
//query the database
$query = "SELECT * FROM add_lat_book WHERE id='$p_id'";
...
$b_img= $query_row['b_img'];

$_SESSION['book_name']=$book_name;
$_SESSION['book_id']=$p_id;
...
<div class="wrapper">
	     <div class="left1">
	<img src="latest_book_uploads/<?php echo $b_img;?>" width="259" height="259" />
</div>
		 <font color=white>
		 <div align="center" >
	    &nbsp;&nbsp;&nbsp;&nbsp;<h1>Book Name:-<?php echo $book_name;?></h1><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Author Name:-<?php echo $author_name;?></h1><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Book category:-<?php echo $book_catetgory;?></h1><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Book Publisher :-<?php echo $book_publisher;?></h1><br/>
		
	     </div></font>
		 <div>
		  &nbsp;&nbsp;&nbsp;&nbsp;<a href="latest_book_review.php?p_name=<?php echo $book_name ?>">View Review</a>
		      &nbsp;&nbsp;&nbsp;&nbsp;<a href="latest_book_pay.php?p_name=<?php echo $book_name?>">Pay And Download</a>
			 &nbsp;&nbsp;&nbsp;&nbsp;<a href="latest_rate.php?p_name=<?php echo $p_id?>">Rate it</a></h1>
<?php
