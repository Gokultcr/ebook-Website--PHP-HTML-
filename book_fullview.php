			...
			<div class="header_sub">
				<div class="h_menu">
					<ul>
							...
							<li><a href="user_viewauthors.php">Authors</a></li>
							<li class="active"><a href="user_viewbooks.php">Books</a></li>
							<li><a href="user_viewlatest.php">Latest</a></li>
							<li><a href="user_uploadownbooks.php">Upload Your Book</a></li>
...
<div class="wrapper">
	...
	<img src="book_uploads/<?php echo $b_img;?>" width="259" height="259" />
		...
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Book Publisher :-<?php echo $book_publisher;?></h1><br/>
		 ...
		 <div>
		 <font color=white>
		      &nbsp;&nbsp;&nbsp;&nbsp;<a href="book_review.php?p_name=<?php echo $book_name?>">View Review</a>
		      &nbsp;&nbsp;&nbsp;&nbsp;<a href="book_pay.php?p_name=<?php echo $book_name?>">Pay And Download</a>
			   &nbsp;&nbsp;&nbsp;&nbsp;<a href="rate.php?p_name=<?php echo $p_id?>">Rate it</a>
