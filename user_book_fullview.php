...
<?php 
//query the database
$query = "SELECT * FROM user_add_book WHERE id='$p_id'";
...
{
$p_id = $query_row['id'];
$a_bname = $query_row['a_bname'];
$a_author = $query_row['a_author'];
$a_cate = $query_row['a_cate'];
$a_pub = $query_row['a_pub'];
$a_book = $query_row['a_book'];
...
<div class="wrapper">
	     <div class="left1">
	<img src="user_book_uploads/<?php echo $b_img;?>" width="259" height="259" />
</div>
		 <font color=white>
		 <div align="center" >
	    &nbsp;&nbsp;&nbsp;&nbsp;<h1>Book Name:-<?php echo $a_bname;?></h1><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Author Name:-<?php echo $a_author;?></h1><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Book category:-<?php echo $a_cate;?></h1><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;<h1>Book Publisher :-<?php echo $a_pub;?></h1><br/>
		
	     </div></font>
		 <div>
		         &nbsp;&nbsp;&nbsp;&nbsp;<h1><a href="user_upload/<?php echo $a_book ?>" target="_blank">Download book</a>
<?php
