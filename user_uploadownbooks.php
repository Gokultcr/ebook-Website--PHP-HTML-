...
<script src="js/owl.carousel.js"></script>
	<script>
      ...
      function validate()
      {
		 ...
		 if( document.myForm.b_aname.value == "" )
         {
            alert( "Please provide Author Name!" );
            document.myForm.b_aname.focus() ;
            return false;
         }
		 if( document.myForm.b_cate.value == "" )
         {
            alert( "Please provide a Book category!" );
            document.myForm.b_cate.focus() ;
            return false;
         }
         
		 if( document.myForm.b_publi.value == "" )
         {
            alert( "Please provide Book publisher!" );
            document.myForm.b_publi.focus() ;
            return false;
         }
			...
			<div class="header_sub">
				<div class="h_menu">
					<ul>
							...
							<li class="active"><a href="user_uploadownbooks.php">Upload Your Book</a></li>
			...
			<div class="footer">
				<div class="wrap">
					...
					<div class="footer-right">
						...
						<div class="comments1">
							<center>
					<form action="user_bookadd.php" method="post" name="myForm" onsubmit="return(validate());" enctype="multipart/form-data">
					
						<td><tr><input type="text" name="b_name" placeholder="Book Name"></td></tr><br/><br/>
                         <td><tr><input type="text" name="b_aname" placeholder="Author Name"></td></tr><br/><br/>
						 <td><tr><input type="text" name="b_cate" placeholder="Book Category"></td></tr><br/><br/>
						 <td><tr><input type="text" name="b_publi" placeholder="Book Publisher"></td></tr><br/><br/>
                         
						<td><tr><input type="submit" value="Add Book"><td><tr>
