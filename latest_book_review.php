...
$id=$_SESSION['book_id'];
//query the database
$query = "SELECT * FROM latest_review WHERE bnam='$p_id'";
...
<tr border=1>
	     <div align="left">
	<font color=white>&nbsp;&nbsp;&nbsp;&nbsp;<h1>Message:-<?php echo $msg;?></h1></font>
	<font color=white>&nbsp;&nbsp;&nbsp;&nbsp;<h1>Name:-<?php echo $nam;?></h1><br/></font>
</tr>
...
<font color=white><center>
		      &nbsp;&nbsp;&nbsp;&nbsp;<a href="latest_book_review_add.php?p_name=<?php echo $p_id?>">Add Review</a></font></center>
		</table>
