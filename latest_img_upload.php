...
<?php
 ...
 $targetfolder = "latest_book_uploads/";
...
if(move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder))
 ...
 $p_img=''; //dummy image
	...
	echo "$bu_nam";
	$query="UPDATE add_lat_book SET b_img='$p_img' WHERE a_bname='$bu_nam'";
	$ql=mysql_query($query);
	if($ql==1)
	{
		echo "<script type='text/javascript'>alert('Uploaded Successfully!');window.location='latestuploadbook.html';</script>";
