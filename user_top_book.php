			...
			<div class="header_sub">
				<div class="h_menu">
					<ul>
							...
							<li><a href="user_viewlatest.php">Latest</a></li>
							<li><a href="user_uploadownbooks.php">Upload Your Book</a></li>
							<li class="active"><a href="user_top_book.php">Top Rated Books</a></li>
							<li><a href="contact.html">Contact us</a></li>
							<li><a href="about.html">About us</a></li>
...
{
$p_id = $query_row['b_id'];
$book_name = $query_row['b_name'];
$rate= $query_row['b_rate'];
...
?>
<tr>
<td align="center"><img src="book_uploads/<?php echo $book_img;?>" width="120" height="150" /></td>
