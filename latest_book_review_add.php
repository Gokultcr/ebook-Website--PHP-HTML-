			...
			<div class="footer">
				<div class="wrap">
					...
					<div class="footer-right">
						...
						<div class="comments1">
						<center>
							<form action="latest_review.php" method="post">
							
							<input type="hidden" name="bnam" value="<?php echo $banm?>">
							
					<textarea id="message" name="msg" onclick="this.value='';"></textarea>
					<input type="type" name="nam" placeholder="name">

    <br />

    <input id="btnPostMessage" type="submit" value="POST MESSAGE" />
